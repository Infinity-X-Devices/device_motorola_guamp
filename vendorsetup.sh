...
# Vendor
git clone https://github.com/Deivid-21s-Sources/proprietary_vendor_motorola_guamp.git -b lineage-22.2 vendor/motorola/guamp --depth=1
...
# Moto Camera
git clone https://gitlab.com/Deivid21/proprietary_vendor_motorola_MotCamera2.git -b android-15 vendor/motorola/MotCamera2 --depth=1
...
git clone https://gitlab.com/Deivid21/proprietary_vendor_motorola_MotCamera2AI.git -b android-15 vendor/motorola/MotCamera2AI --depth=1
